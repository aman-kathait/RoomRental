...
import { registerUser,loginUser,logoutUser, verifyEmail, refreshAccessToken, changePassword, getCurretUser, resendEmailVerification, forgotPassword, verifyForgotPasswordOtp, resetPassword, updateProfile } from '../controllers/auth.controller.js';
...
router.route("/update-profile/:id").put(verifyJWT, updateProfile);
