...
const Footer = () => {
  return (
    <footer class="bg-[#F8FAFC] border-t border-slate-200 w-full">
      <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
        <div>
          <h2 class="text-2xl font-bold text-[#0284C7]">RentEasy</h2>
        ...
        <div>
          <h3 class="text-slate-900 font-semibold mb-3">Company</h3>
          <ul class="space-y-2 text-sm text-slate-600">
            <li>
              <a href="#" class="hover:text-[#0284C7]">
                About Us
              </a>
            </li>
            <li>
        ...
        <div>
          <h3 class="text-slate-900 font-semibold mb-3">Support</h3>
          <ul class="space-y-2 text-sm text-slate-600">
            <li>
              <a href="#" class="hover:text-[#0284C7]">
                Help Center
        ...
        <div>
          <h3 class="text-slate-900 font-semibold mb-3">Follow Us</h3>
          ...
          <div class="flex gap-4">
            <a
              href="#"
              aria-label="Facebook"
              class="p-2 rounded-full border border-slate-300 text-slate-600 hover:bg-[#0284C7] hover:text-white hover:border-[#0284C7] transition"
            >
      ...
      <div class="border-t border-slate-200 py-4 text-center text-sm text-slate-500">
        © 2025 <span class="text-[#0284C7] font-medium">RentEasy</span>. All
        rights reserved.
      </div>
    </footer>
  );
